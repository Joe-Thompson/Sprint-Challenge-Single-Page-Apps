...
> Answer:   Faster, no lose of info from refreshed page.
- [ ] What does AJAX stand for?
> Answer:   Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer:   Components set to state, where react can set the value, using the virtual dom, not the actual dom
